...
<li class="breadcrumb-item text-dark"><a href="{{route('admin.brand')}}">brand</a></li>
<li class="breadcrumb-item text-dark"> <i class="fa fa-home"></i> <a href="{{route('admin.category')}}">Expense</a></li>
@endsection
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">All Expense List</h4>
                ...
                <div class="float-right d-flex my-auto gap-3">
                    ...
                    <form class="mb-0 pb-0" id="sort_categories" action="" method="GET">
                        <div class="input-group py-0 my-0">
                            <input type="text" name="search" class="form-control" id="inputGroupFile02" placeholder="Search By Name...">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Add New expenses</h1>
                    ...
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" type="text" name="HID-date" placeholder="expenses Name English..." value="">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>expenses Name Bangla</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="expenses Name bangla..." value="">
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label>expenses Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="expenses Name English..." value="Damage Product">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>expenses Name Bangla</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="expenses Name bangla..." value="Damage Product">
                            </div>
        ...
        <div class="modal fade" id="viewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">View expenses</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label>expenses Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="expenses Name English..." value="Damage Product" disabled>
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>expenses Name Bangla</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="expenses Name bangla..." value="Damage Product" disabled>
                            </div>
