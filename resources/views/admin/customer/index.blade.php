    ...
    <div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb bg-white">
                <li class="breadcrumb-customer"> <a href="{{ route('admin.dashboard') }}" class="text-primary"><i
        ...
        <div class="col-md-6">
            <ol class="float-right button">
                <a href="{{ route('admin.customers.create') }}" class="btn btn-success" rel="tooltip" id="add"
                    title="add">
                    Add New
                </a>
            </ol>
        ...
        <div class="col-12 p-0">
            <div class="card">
                <div class="card-header justify-content-between py-3">
                    <h4 class="card-title float-left pt-2">All Customer</h4>
                            ...
                            @if (count($customers) > 0)
                                @foreach ($customers as $key => $customer)
                                    <tr>
                                        <td>{{ $customer->id }}</td>
                                        <td>
                                            <img src="{{ asset('uploads/customers/' . $customer->thumbnail) }}"
                                                alt="{{ $customer->thumbnail }}" width="80">
                                        </td>
                                        <td class="Customer-name text-start" style="line-height:1.5; min-width:150px">
                                            <p>{{ $customer->name }}</p>
                                        </td>
