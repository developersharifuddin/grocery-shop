...
<li class="breadcrumb-item text-dark"><a href="{{route('admin.brand')}}">Purchase Return</a></li>
@endsection
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">List of Return Purchase order</h4>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Add New Purchase Return</h1>
                    ...
                    <div class="modal-body px-md-4">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                <label>Purchase Return Qty</label>
                                <input class="form-control" type="number" name="total_product" value="36" disabled>
                            </div>
                            <div class="mb-3 col-md-4">
        ...
        <div class="modal fade" id="viewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">View Purchase Return</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
