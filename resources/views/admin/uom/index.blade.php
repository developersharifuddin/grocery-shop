    ...
    <div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item text-dark"><a href="{{ route('admin.uoms.index') }}">uoms</a></li>
            </ol>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12 p-0">
            <div class="card">
                <div class="card-header justify-content-between py-3">
                    <h4 class="card-title float-left pt-2">All uoms</h4>

                    <div class="float-right d-flex">
                        <form action="{{ route('admin.uoms.index') }}" method="GET"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="name_english"
                                        placeholder="uom Name English..." value="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>uom Name Bangla</label>
                                    <input class="form-control" type="text" name="name_bangla"
                                        placeholder="uom Name bangla..." value="">
                                </div>

                                <div class="mb-3 col-md-4">
                                    <label>uom Logo</label>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="uom Name English..." value="Fresh Fresh">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>uom Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="uom Name bangla..." value="Fresh Fresh">
                                </div>
                        ...
                        <div class="modal-body px-md-4">
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    <label>uom Name</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="uom Name English..." value="Fresh Fresh" disabled>
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>uom Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="uom Name bangla..." value="Fresh Fresh" disabled>
                                </div>
