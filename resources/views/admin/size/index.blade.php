    ...
    <div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item text-dark"><a href="{{ route('admin.sizes.index') }}">sizes</a></li>
            </ol>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12 p-0">
            <div class="card">
                <div class="card-header justify-content-between py-3">
                    <h4 class="card-title float-left pt-2">All sizes</h4>
                            ...
                            @if (count($sizes) > 0)
                                @foreach ($sizes as $key => $size)
                                    <tr>
                                        ...
                                        {{-- <td>{{ $sizes->total() - $sizes->perPage() * ($sizes->currentPage() - 1) - $loop->index }}</td> --}}

                                        <td>{{ $size->name_en }}</td>
                                        <td>{{ $size->name_bn }}</td>
                                        <td>
                                            <p class="text-start" style="max-width:250px"> {{ $size->description }}
                                            </p>
                                        </td>
                                        <td>
                        ...
                        <div class="pagination d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="dataTables_info pl-2">
                                    Showing
                                    <span id="showing-entries-from">{{ $sizes->firstItem() }}</span>
                                    to
                                    <span id="showing-entries-to">{{ $sizes->lastItem() }}</span>
                                    of
                                    <span id="total-entries">{{ $sizes->total() }}</span>
                                    entries
                                </div>
                            </div>
                            <!-- ... (remaining content) -->
                            {{ $sizes->links('components.pagination.default') }}
            ...
            <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="addModalLabel">Edit size</h1>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="size Name English..." value="Fresh Fresh">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>size Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="size Name bangla..." value="Fresh Fresh">
                                </div>
            ...
            <div class="modal fade" id="viewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="addModalLabel">View size</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body px-md-4">
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    <label>size Name</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="size Name English..." value="Fresh Fresh" disabled>
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>size Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="size Name bangla..." value="Fresh Fresh" disabled>
                                </div>
