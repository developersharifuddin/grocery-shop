                ...
                <div class="card-header justify-content-between py-3">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="input-group mr-2">
                            <div class="input-group">
                                <select name="customer_id" class="form-select @error('customer_id') is-invalid @enderror" id="customer_idd">
                            ...
                            <div class="bg-white p-1">
                                <section id="checkout-sidebar" class="check-sidebar">
                                    ...
                                    <div class="checkout-sidebar__content">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="payment_type" id="bkash" value="bkash">
                                            <label class="form-check-label" for="bkash">Bkash</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="payment_type" id="nagod" value="nagod">
                                            <label class="form-check-label" for="nagod">Nagod</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="payment_type" id="rocket" value="rocket">
                                            <label class="form-check-label" for="rocket">Rocket</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="payment_type" id="bank" value="bank">
