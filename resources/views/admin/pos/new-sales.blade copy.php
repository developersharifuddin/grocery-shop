                                            ...
                                            <div class="col-md-6 pr-5">
                                                ...
                                                <div class="row">
                                                    <div class="col-5 pr-1">
                                                        <select name="other_charges" id="other_charges" class="form-control border @error('other_charges') is-invalid @enderror">
                                                            <option>None</option>
                                            ...
                                            <table class="col-md-12">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-right" style="padding-left:10%;font-size: 14px;">
                                                            <b id="grand_total" name="total_amt">0.00</b>
                                                        </th>
                                                    </tr>
                                                </tbody>
                                            </table>
                    ...
                    setTimeout(() => {
                        ...
                        if (item && item.data) {
                            ...
                            if (existingRow) {
                                ...
                                <td> <input type="number" class="form-control total_amount" name="product_total_amount" value="${(item.data.min_qty * item.data.sell_price) - item.data.discount}"></td> 
