    ...
    <div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb bg-white">
                <li class="breadcrumb-purchaseOrder"> <a href="{{ route('admin.dashboard') }}" class="text-primary"><i
        ...
        <div class="col-md-6">
            <ol class="float-right button">
                <a href="{{ route('admin.purchase-orders.create') }}" class="btn btn-success" rel="tooltip" id="add"
                    title="add">
                    Add New
                </a>
            </ol>
                        ...
                        <tbody id="datatable">
                            @forelse ($purchaseOrders as $key => $purchaseOrder)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.purchase-orders.destroy', $purchaseOrder->id) }}"
