                            ...
                            @if (count($brands) > 0)
                                @foreach ($brands as $key => $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ $brand->logo ? asset('uploads/brand/' . $brand->logo) : asset('uploads/brand/default.png') }}"
                                        ...
                                        <td>
                                            <a link="#" href="{{ route('admin.brands.edit', $brand->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="name_bangla"
                                        placeholder="brand Name bangla..." value="">
                                </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="brand Name English..." value="Fresh Fresh">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Brand Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="brand Name bangla..." value="Fresh Fresh">
                                </div>
                        ...
                        <div class="modal-body px-md-4">
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    <label>brand Name</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="brand Name English..." value="Fresh Fresh" disabled>
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>brand Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="brand Name bangla..." value="Fresh Fresh" disabled>
                                </div>
