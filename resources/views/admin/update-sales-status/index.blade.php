...
<li class="breadcrumb-item text-dark"><a href="{{route('admin.brand')}}">Update Sales Status</a></li>
@endsection
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2"> Sells Man Wise hand Over Product List</h4>
                ...
                <div class="float-right d-flex my-auto gap-3">
                    ...
                    <div class="form-group mb-0">
                        <select id="mySelect" class="selectpicker" data-live-search="true">
                            <option selected>Sells Status</option>
                            <option>Sells</option>
                            <option>Pending for Sells</option>
                            <!-- Add more options as needed -->
                        </select>
                    </div>
                ...
                <table id="example1" class="table table-hover">
                    ...
                    <tbody id="datatable">
                        <tr>
                            ...
                            <td>50 PCS</td>
                            <td>50 PCS</td>
                            <td><span class="badge bg-success">Sells</span></td>
                            <td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="viewModalLabel">Update Sales Status</h1>
                    ...
                    <div class="modal-body px-md-4">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                <label>Total Handover Qty</label>
                            ...
                            <table class="table mt-4 aiz-table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">673390 TK</td>
