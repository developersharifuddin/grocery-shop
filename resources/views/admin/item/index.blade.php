                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="product Name English..." value="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="Name Bangla..." value="">
                                </div>

                                <div class="mb-3 col-md-4">
                                    <label>Bin Number</label>
                                    <input class="form-control" type="number" name="bin"
                                        placeholder="Bin Number..." value="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Email</label>
                                    <label>Email</label>
                                    <input class="form-control" type="email" name="bin" placeholder="email..."
                                        value="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Image</label>
                        ...
                        <div class="modal-body px-md-4">
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    <label>product Name</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="product Name English..." value="madina group of industries Dhaka">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="Name Bangla..." value="madina group of industries Dhaka">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Bin Number</label>
                                    <input class="form-control" type="number" name="bin"
                        ...
                        <div class="modal-body px-md-4">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    <label>Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="Name Bangla..." value="madina group of industries Dhaka" disabled>
                                </div>
