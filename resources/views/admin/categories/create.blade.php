                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_english" class="form-control @error('name_english') is-invalid @enderror" id="name_english" placeholder="Enter Name English..." value="{{ old('name_english') }}">
                            @error('name_english')
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_bangla" class="form-control @error('name_bangla') is-invalid @enderror" id="name_bangla" placeholder="name_bangla" value="{{ old('name_bangla') }}">
                            @error('name_bangla')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="parent_id" class="form-control @error('parent_id') is-invalid @enderror" id="parent_id">
                                ...
                                <option value="{{ $category->id }}" {{ old('parent_id') == $category->id ? 'selected' : '' }}>{{ $category->name_english }}</option>
                                @endforeach
                            </select>
                            @error('parent_id')
                            <div class="invalid-feedback">{{ $message }}</div>
