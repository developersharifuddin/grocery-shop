                        ...
                        <form action="{{ route('admin.categories.index') }}" method="GET"
                            ...
                            <div class="form-group mb-0 d-flex w-auto">
                                ...
                                <select name="parent_id" id="Select">
                                    <option value="" value=""
                                        {{ request('parent_id') == '' ? 'selected' : '' }}>-- Select Parent --</option>
                            ...
                            @if (count($categories) > 0)
                                @foreach ($categories as $key => $category)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ $category->logo ?? "asset('storage/default.jpg", "asset('storage/default.jpg')" }}"
                                    ...
                                    <input class="form-check-input" type="checkbox" id="switchButton" checked>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.categories.edits', $category->slug) }}"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="Category Name English..." value="Fresh Water">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Category Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="Category Name bangla..." value="Fresh Water">
                                </div>
                        ...
                        <div class="modal-body px-md-4">
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    <label>Category Name</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="Category Name English..." value="Fresh Water" disabled>
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label>Category Name Bangla</label>
                                    <input class="form-control" type="text" name="HID-date"
                                        placeholder="Category Name bangla..." value="Fresh Water" disabled>
                                </div>
