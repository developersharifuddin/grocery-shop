...
<li class="breadcrumb-item text-dark"><a href="{{route('admin.brand')}}">Unit</a></li>
@endsection
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">All Unit Set</h4>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Add New uom-set</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label>uom-set Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom-set Name English..." value="">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>uom-set Short Code</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom-set Short Code..." value="">
                            </div>
        ...
        <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Edit uom-set</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label>uom-set Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom-set Name English..." value="LD liquid">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>uom-set Short Code</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom-set Short Code..." value="LD liquid">
                            </div>


                            <div class="mb-3 col-md-4">
                                <label>uom-set Group</label>
        ...
        <div class="modal fade" id="viewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">View uom-set</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label>uom-set Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom-set Name English..." value="LD liquid" disabled>
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>uom-set Short Code</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom-set Short Code..." value="LD liquid" disabled>
                            </div>
