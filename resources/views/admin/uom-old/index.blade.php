    ...
    <div class="col-12 p-0">
                ...
                <div class="float-right d-flex my-auto gap-3">
                    <div class="form-group mb-0">
                        ...
                        <select id="mySelect" class="selectpicker" data-live-search="true">
                            <option selected>UOM Group</option>
                    ...
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" type="text" name="HID-date" placeholder="uom Name English..." value="">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>Uom Short Code</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="Uom Short Code..." value="">
                            </div>
        ...
        <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Edit uom</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label>uom Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom Name English..." value="Litter liquid">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>Uom Short Code</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="Uom Short Code..." value="Litter liquid">
                            </div>
        ...
        <div class="modal fade" id="viewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">View uom</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label>uom Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="uom Name English..." value="Litter liquid" disabled>
                            </div>
                            <div class="mb-3 col-md-4">
                                <label>Uom Short Code</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="Uom Short Code..." value="Litter liquid" disabled>
                            </div>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control" placeholder="Leave a  Title here.." id="floatingTextarea" disabled></textarea>
                            </div>
