...
<div class="row">
    <div class="card bg-white p-0">
        <div class="card-header bg-light">
            <form action="{{ route('admin.mothlyProfitLoss.find') }}" class="form-horizontal" id="sales-form" method="POST" accept-charset="utf-8">
                @csrf
                @method('POST')
        ...
        <div class="container p-4">
            ...
            <a href="{{ url('/admin/mothlyProfitLoss-find-report') }}?from_date={{ $from_date }}&to_date={{ $to_date }}" target="_blank" class="btn btn-success float-md-right mr-4">
                Generate PDF
            </a>
            @endif
            @endif
                    ...
                    <table id="example1" class="table table-hover">
                        ...
                        <tfoot>
                            ...
                            <td style="text-align: right;">
                                <strong>{{ number_format($DailyExpenses->sum('amount'), 2, '.', ',') }} TK.</strong>
                            </td>
                        </tfoot>
                    </table>
                ...
                <div class="row">
                    <table id="example1" class="table table-hover">
                        ...
                        <tfoot>
                            ...
                            <td style="text-align: right;">
                                <strong>{{ number_format($AllpurchaseOrders->sum('total_purchase_amount'), 2, '.', ',') }} TK.</strong>
                            </td>
                        </tfoot>
                    </table>
                    <div class="d-flex justify-content-end">
                ...
                <div class="row">
                    <table id="example1" class="table table-hover">
                        ...
                        <tfoot>
                            ...
                            <td style="text-align: right;">
                                <strong>{{ number_format($Allsales->sum('payable'), 2, '.', ',') }} TK.</strong>
                            </td>
                        </tfoot>
                    </table>
                    <div class="d-flex justify-content-end">
