    ...
    <div style="margin-left:5px; margin-top:20px; display:block;">
        ...
        <div class="report_params_areas" style="float:left;height:20px;width:100%">
            ...
            <p style="text-align: left; font-size:12px">
                <b>Total Income:</b> {{number_format($totalIncome, 2, '.', ',')}} TK.</p>
            <p style="text-align: left; font-size:12px">
                <b>Total Expense:</b> {{number_format($totalExpense, 2, '.', ',')}} TK.</p>
            <p style="text-align: left; font-size:12px">
                <b>Net Profit Loss:</b> {{number_format($netProfitLoss, 2, '.', ',')}} TK.</p>
