    ...
    <div class="row">
        <div class="card bg-white p-0">
            <div class="card-header bg-light">
                <form action="{{ route('admin.transdetailsbysupplier.find') }}" class="form-horizontal" id="sales-form"
            ...
            <div class="container p-4">
                @if (isset($tdForSupplier) && count($tdForSupplier) > 0)
                    ...
                    @if ($id && $from_date && $to_date)
                        <a href="{{ url('/admin/transactions-detailed-by-supplier-find-report') }}?supplier_id={{ $id }}&from_date={{ $from_date }}&to_date={{ $to_date }}"
                                ...
                                <table id="example1" class="table table-hover">
                                    ...
                                    <tfoot>
                                        ...
                                        <td style="text-align: right;">
                                            <strong>{{ number_format($tdForSupplier->sum('payable'), 2, '.', ',') }}</strong>
                                        </td>
                                    </tfoot>
                                </table>
