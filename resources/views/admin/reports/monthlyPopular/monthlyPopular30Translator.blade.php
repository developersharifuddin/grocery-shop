...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">
                    {{ __('9B_B_05G2 Monthly Most Popular 30 Translator') }}
                </h1>
            </div>
            ...
            <div class="card-header justify-content-betweens flex">
                ...
                <div class="">
                    ...
                    @if(request('from_date') && request('to_date'))
                        <a href="{{url('/admin/bb-b-05g2-pdf')}}?from_date={{request('from_date')}}&to_date={{request('to_date')}}" target="_blank" class="btn btn-success">
                           PDF
                        </a>
                    @endif
                </div>
            ...
            <tbody>
                @foreach ($data as $key=>$item)
                    <tr>
                        ...
                        <td style="text-align: left">{{ $item->translatorNameBn}}</td>
