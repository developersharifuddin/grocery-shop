...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">
                    {{ __('9B_B_05G3 Monthly Most Popular 30 Editor') }}
                </h1>
            </div>
            ...
            <div class="card-header justify-content-betweens flex">
                <div class="col-9">
                    <div class="row">
                        ...
                        <div class="col-4 d-flex align-items-center">
                            <label class="mr-2 ml-2 fw-700"  for="">To Date:</label>
                ...
                <div class="">
                    ...
                    @if(request('from_date') && request('to_date'))
                        <a href="{{url('/admin/bb-b-05g3-pdf')}}?from_date={{request('from_date')}}&to_date={{request('to_date')}}" target="_blank" class="btn btn-success">
                          PDF
                        </a>
                    @endif
                </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center">Editor Name</th>
            ...
            <tbody>
                 @foreach ($data as $key=>$item)
                    <tr>
                        ...
                        <td style="text-align: left">{{ $item->editorNameBn}}</td>
