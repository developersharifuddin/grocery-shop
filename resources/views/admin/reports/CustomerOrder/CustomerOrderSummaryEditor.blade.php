...
@section('content')
    <div class="mt-2 mb-3 text-left aiz-titlebar">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">
                    {{ __('9B_B_05B3 Customer Order Summary By Editor') }}
                </h1>
            </div>
    ...
    <div class="shadow card">
        <form id="searchOrder" action="{{ url()->current() }}" method="GET">
            ...
            <div class="flex card-header justify-content-betweens">
                ...
                <div class="">
                    ...
                    <a href="{{ route('admin.report.CustomerOrderSummaryEditor') }}" id="reset" class="btn btn-warning">Reset</a>
                    @if(request('from_date') && request('to_date'))
                        <a href="{{url('/admin/bb-b-05b3-pdf')}}?from_date={{request('from_date')}}&to_date={{request('to_date')}}" target="_blank" class="btn btn-success">
                           PDF
                        </a>
                    @endif
                </div>
        ...
        <p class="m-3 fs-17">Editor: <b>{{ $item['editorNameBn'] }}</b></p>
        <table class="table ">
            <thead>
                <tr>
                    ...
                    <th style="text-align: right" width="10%">Price(BDT)</th>
                    <th style="text-align: right" width="10%">Amount(BDT)</th>
