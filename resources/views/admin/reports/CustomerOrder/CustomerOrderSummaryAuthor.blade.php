...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">
                    {{ __('9B_B_05B1 Customer Order Summary By Author') }}
                </h1>
            </div>
    ...
    <div class="card shadow">
        <form id="searchOrder" action="{{ url()->current() }}" method="GET">
            ...
            <div class="card-header justify-content-betweens flex">
                ...
                <div class="">
                    ...
                    <a href="{{ route('admin.report.CustomerOrderSummaryAuthor') }}" id="reset" class="btn btn-warning">Reset</a>
                    @if(request('from_date') && request('to_date'))
                        <a href="{{url('/admin/bb-b-05b1-pdf')}}?from_date={{request('from_date')}}&to_date={{request('to_date')}}" target="_blank" class="btn btn-success">
                           PDF
                        </a>
                    @endif
                </div>
        ...
        <p class="m-3 fs-17">Author: <b>{{ $item['authorNameBn'] }}</b></p>
        <table class="table">
            <thead>
                <tr>
