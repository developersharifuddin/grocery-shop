...
@section('content')
    <div class="mt-2 mb-3 text-left aiz-titlebar">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">
                    {{ __('9B_05B Customer Order Summary') }}
                </h1>
            </div>
    ...
    <div class="shadow card">
        <form id="searchOrder" action="{{ url()->current() }}" method="GET">
            <div class="flex card-header justify-content-betweens">
                ...
                <div class="">
                    ...
                    <a href="{{ route('admin.report.CustomerOrderSummary') }}" id="reset" class="btn btn-warning">Reset</a>
        ...
        @foreach ($data as $item)
            <p class="m-3 fs-17">Publisher's Name: <b>{{ $item['publisherNameBn'] }}</b></p>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($item['data'] as $key => $value)
                    <tr>
                        ...
                        <td style="text-align: center" width="10%">{{ number_format($value->qty) }}</td>
                        <td style="text-align: center" width="10%">Pcs</td>
                        <td style="text-align: right" width="10%">{{ number_format($value->rate, 2, '.', ',') }}</td>
                        <td style="text-align: right" width="10%">{{ number_format($value->amount, 2, '.', ',') }}</td>
